...
const SOFTBOXES = [
  ...
  { name: 'key', width: 6, height: 8, distance: 6, rotationY: 62, elevation: 40, intensity: 5.2 },
  ...
  { name: 'fill', width: 8, height: 8, distance: 7, rotationY: -68, elevation: 10, intensity: 0.9 },
