...
export const DEFAULT_ORDER = Object.freeze({
  ...
  title: 'Посмотрите свой стакан вживую',
  lead: 'Это ваш оплаченный дизайн на реальной геометрии стакана. Покрутите его, приблизьте шов и борт — и согласуйте, если всё нравится.',
  ...
  checklist: [
    ...
    'Контакты и сайт на стакане написаны верно',
  ],
